...
<div   style=" background-color:#FFDA84;heigjt:100% ">
<center>
<h1 style="background-color:LightGray;">your cart </h1>
<table border="1" style="background-color:white;width:75%">
<tr>
<td>image</td>
<td> name</td>
<td>author  name</td>
...
%>
<tr>
<td> <img src="https://image.shutterstock.com/image-vector/open-book-feather-pen-sketch-260nw-696913621.jpg" class="img-fluid img-thumbnail" alt="Sheep"  width="190" height="150"></td>
<td><%=resultSet.getString("name") %></td>
<td><%=resultSet.getString("author") %></td>
<td><%=resultSet.getString("description") %></td>
<td><%=resultSet.getString("rate") %></td>
<td><a href="cartdelete.jsp?name=<%=resultSet.getString("name")%>">delete</a></td>
</tr>
<%
}
connection.close();
...
<button class="ila">check out</button>
</center>
</div>
...
<form action="checkout.jsp">
    ...
    <p>
      <input type="text" class="checkout-input checkout-name" placeholder="Enter Your name">
    ...
    <p>
      <input type="text" class="checkout-input checkout-card" placeholder="enter your card number">
      <input type="text" class="checkout-input checkout-cvc" placeholder="CVC">
    </p>
     </form>
    <p>
     <a href="/DownloadServlet"> <button value="Purchase" class="checkout-btn"> PURCHASE </button> </a>
    </p>
