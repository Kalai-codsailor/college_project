...
<div style=" background-image: url('https://doozyui.com/wp-content/uploads/Book-Icon.gif')" class="container">
	
	<center><h1 style="margin-top:50px"> <b>
                              
                             <span style="background-color: white;font-weight:bold">  விற்பனையாளர்  உள்நுழைவு பக்கம்  </span>  </b> </h1></center> 
	...
	<div class="d-flex justify-content-center h-100" >
		<div class="card" style="background-color:white">
			...
			<div class="card-body">
				...
				<a href="vendor.jsp "> <button>submit</button></a>
			</div>
